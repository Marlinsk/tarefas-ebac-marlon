...
public class NotaDAO extends GenericDAO<Nota, String> implements INotaDAO {
    ...
    public Nota buscarPorChaveAcesso(String chaveAcesso) {
        ...
        return buscarTodos().stream()
                .filter(n -> n.getChaveAcesso() != null && n.getChaveAcesso().equalsIgnoreCase(chaveAcesso))
                .findFirst()
                .orElse(null);
    }
    ...
    public List<Nota> buscarPorSerie(String serie) {
        ...
        return buscarTodos().stream()
                .filter(n -> n.getSerie() != null && n.getSerie().equalsIgnoreCase(serie))
    ...
    public List<Nota> buscarPorVenda(String codigoVenda) {
        ...
        return buscarTodos().stream()
                .filter(n -> n.getVenda() != null && n.getVenda().getCodigo() != null && n.getVenda().getCodigo().equalsIgnoreCase(codigoVenda))
                .collect(Collectors.toList());
    }
    ...
    public List<Nota> buscarPorPeriodo(LocalDateTime inicio, LocalDateTime fim) {
        ...
        return buscarTodos().stream()
                .filter(n -> n.getDataEmissao() != null && (n.getDataEmissao().isEqual(inicio) || n.getDataEmissao().isAfter(inicio)) && (n.getDataEmissao().isEqual(fim) || n.getDataEmissao().isBefore(fim)))
                .collect(Collectors.toList());
    }
